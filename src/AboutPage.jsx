					...
					<div className="AboutRow">
						...
						>
							<li className="AboutLi">
								{/* VAL CHANGE HERE */}
								<p>
									We are a dedicated and diverse team who works together to
									build and code the best robots we can. Our club is
									student-run, so every student gets a chance to participate and
									claim an important role in the process. Our officer posts are
									also constantly changing, so there are always ways to do more!{" "}
								</p>
							</li>
						</ul>
					</div>
						...
						>
							<li className="AboutLi">
								...
								<p>
									...
									contribute to the code, which is as important as the build. We
									work in java & android-based firmware.
								</p>
							</li>
						</ul>
					</div>
